...
const Home = () => {
  const Data1=
    {
      src: `Home3_Image/Home3_Image1.png`,
  ...
  const Data2 = 
    ...
    {
      src: `Home3_Image/Home3_Image2.png`,
  ...
  const Data3 = 
    ...
    {
      src: `Home3_Image/Home3_Image3.png`,
  ...
  return (
    ...
    <div className='Home3'>
      <div className='Home3_Left'>
        <Home3_Sections src={Data1.src} h1={Data1.h1} p={Data1.p} />
        <Home3_Sections src={Data2.src} h1={Data2.h1} p={Data2.p} />

      </div>
      <div className='Home3_Right'>
        <Home3_Sections src={Data3.src} h1={Data3.h1} p={Data3.p} />
